...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2015, 1, 1), new DateTime(2015, 1, 20), 750);
            var remainingFlight = new Flight(new DateTime(2015, 1, 10), new DateTime(2015, 1, 30), 500);
